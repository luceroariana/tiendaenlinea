...
@section('contenido')
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item item3"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>10% de <span>Descuento</span></h3>
						<p>CÓDIGO: KYLIE</p>
						<a class="hvr-outline-out button2" href="mens.html">Comprar</a>
					</div>
				</div>
			...
			<div class="item item4"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Nuevos <span>Metálicos</span></h3>
						<p>Lime Crime</p>
						<a class="hvr-outline-out button2" href="mens.html">Comprar</a>
					</div>
				</div>
            ...
            <div class="banner_bottom_agile_info_inner_w3ls">
					 ...
					 <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
						<figure class="effect-roxy">
							<img src="imagenes/carrusel/29.jpg" alt=" " class="img-responsive" />
							<figcaption>
								<!-- <h3><span>F</span>avoritos</h3> -->
								<a href=""><h3><span>F</span>avoritos</h3>
								<p>Ver más</p></a>
							</figcaption>			
						</figure>
					</div>
	...
	<div class="schedule-bottom">
		<div class="col-md-6 agileinfo_schedule_bottom_left">
			<img src="imagenes/carrusel/23.jpg" alt=" " class="img-responsive" />
		</div>
		<div class="col-md-6 agileits_schedule_bottom_right">
			<div class="w3ls_schedule_bottom_right_grid">
				<h3>Envíos <span>GRATIS</span> todo el año</h3>
				<p>A partir de $800.</p>
				<div class="clearfix"> </div>
			</div>
		</div>
...
<!-- //schedule-bottom -->
  <!-- banner-bootom-w3-agileits -->
	...
	<div class="container">
		<h3 class="wthree_text_info">O<span>fertas</span></h3>
	
		<div class="col-md-5 bb-grids bb-left-agileits-w3layouts">
			<a href="womens.html">
			   <div class="bb-left-agileits-w3layouts-inner grid">
					<figure class="effect-roxy">
							<img src="imagenes/carrusel/5.jpg" alt=" " class="img-responsive" />
							<figcaption>
								<h3><span>D</span>escuento </h3>
								<p>50% en glosses Urban Decay</p>
							</figcaption>			
						</figure>
			    </div>
			</a>
		...
		<div class="col-md-7 bb-grids bb-middle-agileits-w3layouts">
		      <a href="mens.html">
		       <div class="bb-middle-agileits-w3layouts grid">
			           <figure class="effect-roxy">
							<img src="imagenes/carrusel/30.jpg" alt=" " class="img-responsive" />
							<figcaption>
								<h3><span>D</span>escuento </h3>
								<p>10% en glosses</p> <br>
								<p>Código: KYLIE</p>
							</figcaption>			
						</figure>
		        </div>
		      ...
		      <div class="bb-middle-agileits-w3layouts forth grid">
						<figure class="effect-roxy">
							<img src="imagenes/carrusel/32.jpg" alt=" " class="img-responsive">
							<figcaption>
								<h3><span>D</span>escuento </h3>
								<p>35% en labiales matte</p>
							</figcaption>		
						</figure>
					</div>
					</a>
...
<!-- /new_arrivals --> 
	<div class="new_arrivals_agile_w3ls_info"> 
		<div class="container">
		    <h3 class="wthree_text_info">N<span>uevos</span></h3>		
				<div id="horizontalTab">
						<ul class="resp-tabs-list">
							<li> Líquidos Matte</li>
							<li> Líquidos Metálicos</li>
							<li> En barra</li>
							<li> Glosses</li>
						</ul>
					...
					<!--/tab_one-->
						<div class="tab1">
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="imagenes/limeCrime/3-3.jpg" alt="" class="pro-image-front">
										<img src="imagenes/limeCrime/3.jpg" alt="" class="pro-image-back">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Green Blood - Lime Crime</a></h4>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="imagenes/limeCrime/2-2.jpg" alt="" class="pro-image-front">
										<img src="imagenes/limeCrime/2.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Vista rápida</a>
												</div>
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="imagenes/colourPop/1.jpeg" alt="" class="pro-image-front">
										<img src="imagenes/colourPop/1-1.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Vista rápida</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="imagenes/makeupForever/8.png" alt="" class="pro-image-front">
										<img src="imagenes/makeupForever/8.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Vista rápida</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="imagenes/makeupGeek/2-2.jpg" alt="" class="pro-image-front">
										<img src="imagenes/makeupGeek/2.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Vista rápida</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="imagenes/urbanDecay/8.jpg" alt="" class="pro-image-front">
										<img src="imagenes/urbanDecay/8.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Vista rápida</a>
												</div>
		...
		<div class="col-md-9 footer-right">
			<div class="sign-grds">
				...
				<div class="col-md-3 sign-gd flickr-post">
					<h4>EQUIPO</h4>
					<ul>
						<li><a href="single.html"><img src="imagenes/carrusel/7.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="imagenes/carrusel/8.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="imagenes/carrusel/9.jpg" alt=" " class="img-responsive" /></a></li>
					</ul>
				</div>
				<div class="clearfix"></div>
			</div>
